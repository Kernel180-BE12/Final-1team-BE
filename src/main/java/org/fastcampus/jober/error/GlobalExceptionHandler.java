...
public class GlobalExceptionHandler {
    ...
    private ErrorResponse build(ErrorCode ec, String message, HttpServletRequest req, Map<String, Object> details) {
    ...
    public ResponseEntity<ErrorResponse> handleBusiness(BusinessException ex, HttpServletRequest req) {
        ...
        return ResponseEntity.status(ec.getStatus())
                .body(build(ec, ex.getMessage(), req, null));
    }
    ...
    public ResponseEntity<ErrorResponse> handleValidation(Exception ex, HttpServletRequest req) {
        ...
        return ResponseEntity.status(ec.getStatus())
                .body(build(ec, null, req, details));
    }
