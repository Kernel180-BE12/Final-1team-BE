...
public class SpaceController {
  ...
  @Operation(summary = "단일 스페이스 조회", description = "ID를 통해 특정 스페이스의 상세 정보를 조회합니다.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "성공적으로 스페이스 정보를 조회함",
            content =
                @Content(
  ...
  @Operation(summary = "스페이스 수정", description = "스페이스 정보를 수정합니다. (권한이 있는 사용자만 가능)")
  ...
  @Operation(summary = "스페이스 목록 조회", description = "로그인한 사용자가 속한 모든 스페이스 목록을 조회합니다.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    ...
                    array =
                        @ArraySchema(
                            schema = @Schema(implementation = SpaceListResponseDto.class)))),
