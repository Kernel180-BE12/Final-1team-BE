...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * org.fastcampus.jober..controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(public * org.fastcampus.jober..service..*(..))")
    public void serviceMethods() {}

    @Pointcut("execution(public * org.fastcampus.jober..service..repository..*(..))")
