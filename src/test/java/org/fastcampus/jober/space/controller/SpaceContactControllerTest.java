...
//
//  @MockitoBean private SpaceContactService spaceContactService;
//
...
//  void setUp() {
//    // 테스트용 요청 데이터 설정
//    ContactRequestDto.ContactInfo contactInfo =
//        ContactRequestDto.ContactInfo.builder()
//            .name("김철수")
...
//
//    requestDto =
//        ContactRequestDto.builder()
//            .spaceId(1L)
//            .contacts(Collections.singletonList(contactInfo))
//            .build();
//
//    // 테스트용 응답 데이터 설정
//    ContactResponseDto.ContactInfo responseContactInfo =
//        ContactResponseDto.ContactInfo.builder()
//            .id(1L)
//            .name("김철수")
//            .phoneNum("010-1234-5678")
//            .email("kim@example.com")
...
//    // 연락처 수정 요청/응답 데이터 설정
//    updateRequestDto =
//        SpaceContactsUpdateRequestDto.builder()
//            .spaceId(1L)
//            .contactId(1L)
//            .name("김철수(수정)")
...
//
//    // 연락처 삭제 요청 데이터 설정
//    deleteRequestDto = ContactDeleteRequestDto.builder().spaceId(1L).contactId(1L).build();
//  }
//
//  @Test
...
//    // given
//    when(spaceContactService.getContacts(1L)).thenReturn(responseDto);
//
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/1"))
...
//        .thenThrow(
//            new org.fastcampus.jober.error.BusinessException(
//                org.fastcampus.jober.error.ErrorCode.NOT_FOUND, "존재하지 않는 스페이스입니다."));
//
//    // when & then
//    mockMvc.perform(get("/space/contact/999")).andExpect(status().isNotFound());
//  }
//
//  @Test
...
//    // when & then
//    mockMvc.perform(get("/space/contact/invalid")).andExpect(status().isBadRequest());
//  }
//
//  @Test
...
//    // given
//    when(spaceContactService.addContacts(any(ContactRequestDto.class))).thenReturn(responseDto);
//
//    // when & then
//    mockMvc
//        .perform(
...
//    // given
//    ContactRequestDto invalidRequest =
//        ContactRequestDto.builder().spaceId(null).contacts(null).build();
//
//    // when & then
//    mockMvc
//        .perform(
...
//    // given
//    SpaceContactsUpdateRequestDto invalidRequest =
//        SpaceContactsUpdateRequestDto.builder().spaceId(null).contactId(null).build();
//
//    // when & then
//    mockMvc
//        .perform(
...
//    // given
//    ContactDeleteRequestDto invalidRequest =
//        ContactDeleteRequestDto.builder().spaceId(null).contactId(null).build();
//
//    // when & then
//    mockMvc
//        .perform(
...
//            new org.fastcampus.jober.error.BusinessException(
//                org.fastcampus.jober.error.ErrorCode.NOT_FOUND, "존재하지 않는 스페이스입니다."))
//        .when(spaceContactService)
//        .deleteContact(any(ContactDeleteRequestDto.class));
//
//    // when & then
//    mockMvc
//        .perform(
...
//
//    // 태그 검색 결과용 응답 데이터 설정
//    ContactResponseDto.ContactInfo tagContactInfo =
//        ContactResponseDto.ContactInfo.builder()
//            .id(2L)
//            .name("이영희")
...
//            .build();
//
//    ContactResponseDto tagResponseDto =
//        ContactResponseDto.builder()
//            .spaceId(spaceId)
...
//            .build();
//
//    when(spaceContactService.getContactsByTag(spaceId, tag)).thenReturn(tagResponseDto);
//
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", spaceId, tag))
//        .andExpect(status().isOk())
...
//    String tag = "존재하지않는태그";
//
//    ContactResponseDto emptyResponseDto =
//        ContactResponseDto.builder()
//            .spaceId(spaceId)
...
//            .build();
//
//    when(spaceContactService.getContactsByTag(spaceId, tag)).thenReturn(emptyResponseDto);
//
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", spaceId, tag))
...
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", "invalid", "프리랜서"))
...
//    String tag = "개발자-백엔드";
//
//    ContactResponseDto.ContactInfo specialTagContactInfo =
//        ContactResponseDto.ContactInfo.builder()
//            .id(3L)
//            .name("박민수")
...
//            .build();
//
//    ContactResponseDto specialTagResponseDto =
//        ContactResponseDto.builder()
//            .spaceId(spaceId)
...
//            .build();
//
//    when(spaceContactService.getContactsByTag(spaceId, tag)).thenReturn(specialTagResponseDto);
//
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", spaceId, tag))
...
//    String tag = "웹개발자";
//
//    ContactResponseDto.ContactInfo koreanTagContactInfo =
//        ContactResponseDto.ContactInfo.builder()
//            .id(4L)
//            .name("최지영")
...
//            .build();
//
//    ContactResponseDto koreanTagResponseDto =
//        ContactResponseDto.builder()
//            .spaceId(spaceId)
...
//            .build();
//
//    when(spaceContactService.getContactsByTag(spaceId, tag)).thenReturn(koreanTagResponseDto);
//
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", spaceId, tag))
...
//    // when & then
//    mockMvc
//        .perform(get("/space/contact/{spaceId}/{tag}", 1L, "프리랜서"))
